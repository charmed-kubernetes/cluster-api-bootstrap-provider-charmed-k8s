...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CharmedK8sConfigConfigTemplateResource) DeepCopyInto(out *CharmedK8sConfigConfigTemplateResource) {
	*out = *in
	in.Spec.DeepCopyInto(&out.Spec)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CharmedK8sConfigConfigTemplateResource.
func (in *CharmedK8sConfigConfigTemplateResource) DeepCopy() *CharmedK8sConfigConfigTemplateResource {
	if in == nil {
		return nil
	}
	out := new(CharmedK8sConfigConfigTemplateResource)
	in.DeepCopyInto(out)
	return out
}
